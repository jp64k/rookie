**Note: These changes are currently in development and may or may not be merged into Rookie's production version. Linked below is a compiled version with [all of my changes and improvements of the source](https://github.com/VRPirates/rookie/compare/beta/RSL-2.35...jp64k:rookie:RSL-3.0.4).**
